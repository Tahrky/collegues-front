...
export class ColleguesMock {
    ...
    constructor () {
        ...
        this.tab.push (new Collegue ("2", "paul", "Gurpratap Singh", "email@mail.com", "0087-9-28", 
        ...
        this.tab.push (new Collegue ("3", "paul", "Petit", "email@mail.com", "2017-1-5", 
        "https://4.bp.blogspot.com/-7PiHFWz7KA4/T7LBcPobzII/AAAAAAAABsU/W1_U3oFaPz4/s400/rossignol%2Bjaponais.jpg"));
    
        this.tab.push (new Collegue ("4", "paul", "Richard", "email@mail.com", "1947-4-30", 
        ...
        this.tab.push (new Collegue ("5", "marty", "Nicolas", "email@mail.com", "1906-12-5", 
